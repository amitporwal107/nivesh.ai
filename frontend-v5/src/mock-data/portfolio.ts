  ...
  topInsights: [
    {
      ...
      detail:
        "Axis Bluechip, ICICI Pru Bluechip and Mirae Large hold 71% of the same top stocks — you're paying 3× the fees for 1× exposure.",
      evidence: [
    ...
    },
    {
      ...
      detail:
        "About 38% sits in mid- and small-cap names. Fine in good years, painful in bad ones.",
      evidence: [
    ...
    },
    {
      ...
      detail:
        "You hold 1.4 months of expenses in safe cash. The usual target is 6 months — about ₹4.6L more.",
      evidence: [
