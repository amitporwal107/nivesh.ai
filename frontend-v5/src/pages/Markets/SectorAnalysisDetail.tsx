  ...
  return (
    <div className="mx-auto w-full max-w-[1080px] px-6 py-8 lg:px-10 lg:py-10">
      ...
      <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
        ...
        <Metric label="1-year" value={fmtPct(s.metrics.avg_return_1y)} valueClass={tone(s.metrics.avg_return_1y)} />
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-2">
      ...
      <div className="flex shrink-0 items-center gap-4 text-right">
        ...
        <span className={cn("w-14 font-mono text-[12px]", tone(c.return_1y_pct))} title="1-year return">{fmtPct(c.return_1y_pct)}</span>
      </div>
    </div>
  );
}
