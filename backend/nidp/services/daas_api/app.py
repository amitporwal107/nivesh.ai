...
_TAGS = [
    ...
    {"name": "paper_trades",     "description": "Ten-Percent Days paper trade simulation: frozen selections, paths and evaluations (internal keys only)."},
...
app.include_router(paper_trades.router, prefix=v1_prefix)
