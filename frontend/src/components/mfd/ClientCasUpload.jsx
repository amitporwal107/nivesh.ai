 ...
 * has no portfolio yet. Thin wrapper around the existing retail
 * `CasConnectButton` — the session's impersonation layer routes the
 * import to the client's shadow user automatically, so no duplicate
 * upload logic is needed.
 */
      ...
      <div className="flex items-start gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
            Upload {clientName}&apos;s CAS (PDF, Gmail inbox, or live CDSL OTP fetch).
            The holdings are stored against {clientName}&apos;s profile only — your
            own portfolio is unaffected.
          </p>
        </div>
      </div>
